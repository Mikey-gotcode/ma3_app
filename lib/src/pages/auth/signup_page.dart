...
class _SignupPageState extends State<SignupPage> {
  ...
  void _signup() async {
    ...
    // Show a SnackBar based on the signup result
    if (result['success']) {
      ...
      // Navigate based on the role, or to login if no role is provided
      if (role != null) {
        _navigateToRoleScreen(role);
      } else {
        // If signup doesn't return a role, typically you'd go to login
  ...
  void _navigateToRoleScreen(String role) {
    ...
    switch (role.toLowerCase()) {
      ...
      default:
        ...
        route = '/login'; // Or a generic home page if you have one
        break;
    }
